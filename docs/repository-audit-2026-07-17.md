...
| [#485](https://github.com/guberm/gvault/issues/485) | Request bodies are unbounded and unauthenticated synchronous `scrypt` work is not rate-limited. | Fixed in v0.1.13: declared/streamed JSON bounds, `400/413` errors, pre-scrypt account/source limits, explicit trusted-proxy mode, configuration docs, and integration coverage. |
