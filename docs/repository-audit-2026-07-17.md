...
| [#491](https://github.com/guberm/gvault/issues/491) | Live Web lacks CSP and the expected browser security headers. | Fixed in v0.1.17: the public Web/API boundary applies a restrictive CSP, one-year HSTS, `nosniff`, frame denial, no-referrer policy, and a least-privilege Permissions-Policy across HTML, static assets, health, and API responses. |
