...
public final class TestMobileAuthState {
  public static void main(String[] args) {
    ...
    assertEquals("Master password is required.", MobileAuthState.validate("michael@example.com", "account-password", "", "", true));
    ...
    assertEquals("", MobileAuthState.validate("michael@example.com", "account-password", "", "", false));
    assertEquals("", MobileAuthState.validate("michael@example.com", "account-password", "12345678901", "different", false));
